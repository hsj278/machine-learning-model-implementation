...
class DecisionTree():
    def __init__(self, max_depth=None, min_sample_split=2, regression=False, threshold_method='unique', n_features=None, random_foest=False):
        ...
        self.random_forest = random_foest
    ...
    def _best_split(self, X, y):
        ...
        for feature in features:
            ...
            for threshold in thresholds:
                left_idx, right_idx = self._split_dataset(X, y, feature, threshold)
